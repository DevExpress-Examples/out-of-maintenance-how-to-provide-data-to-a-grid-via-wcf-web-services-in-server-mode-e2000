...
Namespace DataObjects
	...
	<System.Data.Linq.Mapping.DatabaseAttribute(Name:="DXGridServerModeDB")> _
	...
	<Table(Name:="dbo.WpfServerSideGridTest")> _
	Partial Public Class WpfServerSideGridTest
		...
		Private _Sent? As System.DateTime
	...
	End Sub
	Partial Private Sub OnSentChanging(ByVal value? As System.DateTime)
	End Sub
	...
	#End Region
		...
		<Column(Storage:="_OID", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=True, IsDbGenerated:=True)> _
		...
		<Column(Storage:="_Subject", DbType:="NVarChar(100)")> _
		...
		<Column(Name:="[From]", Storage:="_From", DbType:="NVarChar(100)")> _
		...
		<Column(Storage:="_Sent", DbType:="DateTime")> _
		...
		<Column(Storage:="_Size", DbType:="BigInt")> _
		...
		<Column(Storage:="_HasAttachment", DbType:="Bit")> _
