        ...
        class GZipMessageEncoder : MessageEncoder
        {
            ...
            public override Message ReadMessage(ArraySegment<byte> buffer, BufferManager bufferManager, string contentType)
            {
                ...
                if(GZipMessageEncoderFactory.MessageSent != null)
                    GZipMessageEncoderFactory.MessageSent(null, new MessageSizeEventArgs(buffer.Count));
            ...
            public override ArraySegment<byte> WriteMessage(Message message, int maxMessageSize, BufferManager bufferManager, int messageOffset)
            {
                ...
                if(GZipMessageEncoderFactory.MessageReceived != null)
                    GZipMessageEncoderFactory.MessageReceived(null, new MessageSizeEventArgs(result.Count));
                return result;
            }
