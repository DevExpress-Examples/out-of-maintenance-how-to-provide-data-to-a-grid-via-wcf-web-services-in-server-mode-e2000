...
{
    public class MessageSizeEventArgs : EventArgs {
        public MessageSizeEventArgs(int messageSize) {
            this.MessageSize = messageSize;
        }
        public int MessageSize { get; private set; }
    }
    public delegate void MeassageSizeEventHandler(object sender, MessageSizeEventArgs e);
    ...
    {
        public static event MeassageSizeEventHandler MessageSent;
        public static event MeassageSizeEventHandler MessageReceived;
        ...
        class GZipMessageEncoder : MessageEncoder
        {
            ...
            public override Message ReadMessage(ArraySegment<byte> buffer, BufferManager bufferManager, string contentType)
            {
                ...
                if(GZipMessageEncoderFactory.MessageReceived != null)
                    GZipMessageEncoderFactory.MessageReceived(null, new MessageSizeEventArgs(buffer.Count));
            ...
            public override ArraySegment<byte> WriteMessage(Message message, int maxMessageSize, BufferManager bufferManager, int messageOffset)
            {
                ...
                ArraySegment<byte> result = CompressBuffer(buffer, bufferManager, messageOffset);
                if(GZipMessageEncoderFactory.MessageSent != null)
                    GZipMessageEncoderFactory.MessageSent(null, new MessageSizeEventArgs(result.Count));
                return result;
            }
